...
public class patientList extends JFrame implements MouseListener,ActionListener  {
    ...
    public patientList(user u,users us) {
        ...
        cancelBtn = new JButton("  Cancel This Appointment?  ");
        cancelBtn.setBounds(240, 350, 165, 45);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (backBtn.getText().equals(command)) {
            ...
            // l = users.k;
            us.deleteUser(l);
            if(noOfPatient==0){JOptionPane.showMessageDialog(this, "No more patients left!");}
            else{
                patientList nw=new patientList(u,us);
                nw.setVisible(true);
                this.setVisible(false);}
